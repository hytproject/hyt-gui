export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "Не найден файл Holoyolod, используется удаленная нода"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    HoloyoloBalance: "Баланс",
    HoloyoloUnlockedBalance: "Разблокированый баланс",
    HoloyoloUnlockedShort: "Разблокировано",
